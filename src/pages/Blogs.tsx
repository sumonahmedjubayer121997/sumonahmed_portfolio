...
const Blogs = () => {
  const blogs = [
    {
      ...
      date: "March 2024",
      excerpt:
        "Lessons learned from building multiple AI products and the importance of shipping quickly.",
      readTime: "5 min read",
    },
    {
      ...
      date: "February 2024",
      excerpt:
        "How AI agents are transforming the insurance industry and what to expect next.",
      readTime: "7 min read",
    },
    {
      ...
      date: "January 2024",
      excerpt:
        "The journey of building Dreamboat.ai and raising our first round of funding.",
  ...
  return (
    <Layout>
      <div className="pt-16 lg:pt-0 px-6 py-12 lg:py-24 max-w-4xl mx-auto relative">
